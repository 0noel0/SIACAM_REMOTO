...
public class DetalleficharetirobasesController implements Serializable {
    ...
    @EJB
    private Modelo.DetalleficharetirobasesFacade ejbFacade;
    ...
    public Detalleficharetirobases getSelected() {
        if (current == null) {
            ...
            current.setDetalleficharetirobasesPK(new Modelo.DetalleficharetirobasesPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Detalleficharetirobases getDetalleficharetirobases(Modelo.DetalleficharetirobasesPK id) {
