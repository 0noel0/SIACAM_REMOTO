...
public class DetallenecesipaacController implements Serializable {
    ...
    @EJB
    private Modelo.DetallenecesipaacFacade ejbFacade;
    ...
    public Detallenecesipaac getSelected() {
        if (current == null) {
            ...
            current.setDetallenecesipaacPK(new Modelo.DetallenecesipaacPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Detallenecesipaac getDetallenecesipaac(Modelo.DetallenecesipaacPK id) {
