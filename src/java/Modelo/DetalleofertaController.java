...
public class DetalleofertaController implements Serializable {
    ...
    @EJB
    private Modelo.DetalleofertaFacade ejbFacade;
    ...
    public Detalleoferta getSelected() {
        if (current == null) {
            ...
            current.setDetalleofertaPK(new Modelo.DetalleofertaPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Detalleoferta getDetalleoferta(Modelo.DetalleofertaPK id) {
